...
<div id="<?php echo $containerId; ?>" class="sortable-panels" data-index="<?php echo count($panels); ?>">
    <?php if (!empty($availablePanels)): ?>
    <div class="available-panels mb-md">
        <div class="row">
            <div class="col-sm-6">
                <select class="available-panel-selector"
                        ...
                        <?php if (isset($appendPanelCallback)) {
    echo ' data-append-sortable-callback="'.$appendPanelCallback.'"';
} ?>
                        <?php if (!empty($appendPanelMessage)) {
    echo ' data-chosen-placeholder="'.$view['translator']->trans($appendPanelMessage).'"';
} ?>>
                    <option value=""></option>
                    <?php
    ...
    <?php if (!count($panels)): ?>
        <div class="alert alert-info col-sm-6 sortable-panel-placeholder">
            <p>
